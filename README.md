# Vanilla-ML-DL — 2000+ концепций ML/DL «на пальцах»

Учебный проект для тех, кто только начинает (и для тех, кто хочет
систематизировать знания). Внутри — **больше 2000 концепций** машинного
обучения и Deep Learning, разобранных короткими самостоятельными
Python-скриптами.
...
- **333 запускаемых скрипта** на Python
...
- [`CONCEPTS_2.md`](CONCEPTS_2.md) — карта расширенного блока (главы 12–70)
- [`STYLE_GUIDE.md`](STYLE_GUIDE.md) — правила оформления

## Совет

Не пытайся осилить все 2000 концепций за один заход. Открой оглавление,
ткни в то, чего сейчас не понимаешь, прочитай один файл, запусти —
и закрой. Возвращайся, когда понадобится ещё.
