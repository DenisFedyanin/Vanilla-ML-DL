# Vanilla-ML-DL — 1000+ концепций ML/DL «на пальцах»

Учебный проект для тех, кто только начинает (и для тех, кто хочет
систематизировать знания). Внутри — **больше тысячи названных концепций**
машинного обучения и Deep Learning, разобранных короткими самостоятельными
Python-скриптами. С учётом всех вариаций и трюков, показанных в коде —
суммарно около двух тысяч идей.
...
- ~1000 названных концепций + сотни мелких вариаций и трюков рядом
